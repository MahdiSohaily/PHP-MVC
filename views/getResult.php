...
if (mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            <td class="blue">
            <?php if($status == "Requset"){?><a class="Requset" target="_blank" href="https://yadakinfo.com/projects/price/mobis-get.php?q=<?php echo $partnumber ?>">?</a><?php } 
            if($status == "NO-Price"){?><a class="NO-Price" target="_blank" href="https://yadakinfo.com/projects/price/mobis-get.php?q=<?php echo $partnumber ?>">!</a><?php } 
            if($status == "NO-Mobis"){?><a class="NO-Mobis" target="_blank" href="https://yadakinfo.com/projects/price/mobis-get.php?q=<?php echo $partnumber ?>">X</a><?php } if($status == "YES-Mobis"){?><div class="empty"></div> <?php } ?>    
            ...
            <td><div class="weight"><?php echo $Weight ?> KG</div></td>
        </tr>  
  <?php
        if($status == "YES-Mobis"){ 
            $price = $row['mobis'];
    ...
    ?>
            <tr class="itsmobis">
                <td class="blue"><div class="empty"></div><?php echo $partnumber ?>-M</td>
